...
#dd1_cell.paint('"soma"', 'CaPool')
dd1_cell.paint('"soma"', 'ca_boyle')
#dd1_cell.paint('"soma"', 'na_from_nrn_hh')

#dd1_cell.paint('"soma"', 'nernst/x=na')
#dd1_cell.paint('"soma"', 'hh')
#dd1_cell.paint('"soma"', 'pas')

dd1_cell.place('"center"', arbor.iclamp(100, 300, 0.007))  #0.001
#dd1_cell.place('"center"', arbor.iclamp(450, 50, 0.0087))
...
seaborn.relplot(data=df, kind="line", x="t/ms", y="U/mV",ci=None).savefig('single_cell_model_result_7_0.svg')

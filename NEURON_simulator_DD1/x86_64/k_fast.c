...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 k_fast /home/kharms/PycharmProjects/NEURON_simulator_DD1/x86_64/k_fast.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kharms/PycharmProjects/NEURON_simulator_DD1/k_fast.mod";
static const char* nmodl_file_text = 

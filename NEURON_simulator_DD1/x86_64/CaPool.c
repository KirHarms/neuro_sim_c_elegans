...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
...
#endif
  hoc_register_prop_size(_mechtype, 12, 7);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "area");
 	...
 	ivoc_help("help ?1 CaPool /home/kharms/PycharmProjects/NEURON_simulator_DD1/x86_64/CaPool.mod\n");
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  states();
 if(error){fprintf(stderr,"at line 85 in file CaPool.mod:\n    \n"); nrn_complain(_p); abort_run(error);}
 } {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kharms/PycharmProjects/NEURON_simulator_DD1/CaPool.mod";
static const char* nmodl_file_text = 

...
Components:
    ...
    offset_current (Type: pulseGenerator:  delay=0.1 (SI time) duration=0.3 (SI time) amplitude=1.0E-12 (SI current))
    DD1_1_0 (Type: network)
    sim_DD1_1_0 (Type: Simulation:  length=0.5 (SI time) step=1.0E-5 (SI time))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        '''
        Adding simulation Component(id=sim_DD1_1_0 type=Simulation) of network/component: DD1_1_0 (Type: network)
        ...
        # ######################   File to save: DD1_1_0.activity.dat (neurons_activity)
        ...
        # ######################   File to save: DD1_1_0.dat (neurons_v)
        # Column: DD1/0/DD1/v

...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "area");
 	...
 	ivoc_help("help ?1 CaPool /home/kharms/c302/test_cell_just_soma/x86_64/CaPool.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kharms/c302/test_cell_just_soma/CaPool.mod";
static const char* nmodl_file_text = 

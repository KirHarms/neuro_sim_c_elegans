...
class ParameterisedModel(c302ModelPrototype):
    ...
    def set_default_bioparameters(self):
        ...
        self.add_bioparameter("initial_memb_pot", "-45 mV", "BlindGuess", "0.1") # default -45 mV
        ...
        self.add_bioparameter("unphysiological_offset_current_del", "100 ms", "KnownError", "0") # default: 0 ms
        self.add_bioparameter("unphysiological_offset_current_dur", "300 ms", "KnownError", "0") # default: 2000 ms
